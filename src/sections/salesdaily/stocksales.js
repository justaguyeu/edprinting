...
export const Stocksales = (props) => {
  ...
  const calculateTotalsOutofstock = (outofstock, selectedDate) => {
  ...
  const totalOut = calculateTotalsOutofstock(filteredOutofstock);
                        ...
                        <Table>
                          ...
                          <TableBody>
                            <TableRow>
                              ...
                              <TableCell>
                                {formatCurrency(totalOut.totalOutofstock)}
                              </TableCell>
                              <TableCell>
                                {formatCurrency(
