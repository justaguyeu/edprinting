...
const Page = () => {
        ...
        if (formData2.item_name) {
            ...
            if (selectedItem) {
                setFormData2(prevData => ({
                    ...prevData,
                    total_price: (selectedItem.price_per_unit * formData2.area_in_square_meters) || ''
                }));
            }
        }
    ...
    const handleSubmit2 = async (e) => {
        ...
        if (token) {
            try {
                const response = await axios.post(`${BASE_URL}/api/stock2/`, formData2, {
                    headers: { Authorization: `Bearer ${token}` },
                });
                setEntries([...entries, response.data]);
    ...
    const handleChange = (e) => {
        ...
        setFormData({
            ...formData,
            [name]: name === 'quantity' || name === 'total_price' || name === 'expenses' ? parseFloat(value) || '' : value
        });
    };
    ...
    const handleChange2 = (e) => {
        ...
        setFormData2({
            ...formData2,
            [name]: name === 'area_in_square_meters' || name === 'total_price' || name === 'expenses' ? parseFloat(value) || '' : value
        });
    };
                                    ...
                                    <CardContent>
                                        ...
                                        >
                                            ...
                                            <input
                                                ...
                                                required
                                            />
                                            <Button variant="contained" type="submit">RESTOCK</Button>
